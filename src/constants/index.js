...
export const navLinks = [
  ...
  },
  {
    id: "work",
    title: "Work",
    link: "https://samuelraymond7.github.io/portofolio/#work",
    content: "What I have done so far.",
  },
  {
    id: "projects",
    title: "Projects",
    link: "https://samuelraymond7.github.io/portofolio/#projects",
    content:
...
export const experiences = [
  {
    ...
    points: [
      ...
      "Used Git and GitHub for version control, collaboration with interns, and code review.",
      "Mentored interns by reviewing code and providing guidance, ensuring consistency and quality across projects.",
      "Implemented MQTT protocol for real-time communication between web applications and Haiwell PLCs.",
      "Programmed and integrated Haiwell PLC, HMI, and using Ladder Diagram.",
      "Developed a computer vision program utilizing OpenCV.",
      "Documented all stages of development to support future maintenance and knowledge sharing.",
      "Basic experience in 3D CAD (SolidWorks, AutoCAD) for simple designs.",
      "Assisted with video editing (Adobe Premiere Pro) and graphic design (Illustrator) for project-related content.",
    ],
  },
  {
    ...
    points: [
      "Researched facial expression detection program using Python.",
      "Utilized computer vision to create a face filter program.",
      "Processed 400+ stock market data using Python.",
      "Evaluated AI models for stock price prediction and conducted simulations.",
      "Developed and tested a prototype stock prediction program using historical data.",
      "Performed experimental validation of the stock prediction model under simulated conditions.",
    ],
  },
];
